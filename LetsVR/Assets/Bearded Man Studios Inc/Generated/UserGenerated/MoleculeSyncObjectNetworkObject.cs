...
namespace BeardedManStudios.Forge.Networking.Generated
{
	...
	public partial class MoleculeSyncObjectNetworkObject : NetworkObject
	{
		...
		public MoleculeSyncObjectNetworkObject() : base() { Initialize(); }
		public MoleculeSyncObjectNetworkObject(NetWorker networker, INetworkBehavior networkBehavior = null, int createCode = 0, byte[] metadata = null) : base(networker, networkBehavior, createCode, metadata) { Initialize(); }
		public MoleculeSyncObjectNetworkObject(NetWorker networker, uint serverId, FrameStream frame) : base(networker, serverId, frame) { Initialize(); }
