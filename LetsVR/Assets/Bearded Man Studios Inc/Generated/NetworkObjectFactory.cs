			...
			MainThreadManager.Run(() =>
			{
				switch (identity)
				{
					case ChatManagerNetworkObject.IDENTITY:
						...
						break;
					case ControllerSyncNetworkObject.IDENTITY:
						availableCallback = true;
						obj = new ControllerSyncNetworkObject(networker, id, frame);
						break;
					...
					case ExampleProximityPlayerNetworkObject.IDENTITY:
						...
						break;
					case MoleculeSyncObjectNetworkObject.IDENTITY:
						availableCallback = true;
						obj = new MoleculeSyncObjectNetworkObject(networker, id, frame);
						break;
